...
location.href="http://114.33.199.92:8080/petshop"    
...
constructor(private action$:Actions,private loginService:LoginService,private messageService:MessageService,private router:Router) { 
  }
}
